...
list1 = List.create(name: "Heros")
list2 = List.create(name: "Fantastic")
list3 = List.create(name: "Thriller")
list4 = List.create(name: "Action")

Bookmark.create!(comment: "Cool movie", movie_id: movie1.id, list_id: list1.id)
Bookmark.create!(comment: "It was nice", movie_id: movie2.id, list_id: list2.id)
Bookmark.create!(comment: "Amazing", movie_id: movie3.id, list_id: list3.id)
